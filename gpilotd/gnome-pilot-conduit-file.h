 ...
 * Public methods
 */
GType	gnome_pilot_conduit_file_get_type	(void) G_GNUC_CONST;
#line 41 "gnome-pilot-conduit-file.gob"
GObject * 	gnome_pilot_conduit_file_new	(GPilotPilot * pilot);
#line 57 "gnome-pilot-conduit-file.h"
#line 50 "gnome-pilot-conduit-file.gob"
int 	gnome_pilot_conduit_file_install_db	(GnomePilotConduitFile * self,
					int pisock,
					gchar * src_file,
					gboolean rm);
#line 63 "gnome-pilot-conduit-file.h"
