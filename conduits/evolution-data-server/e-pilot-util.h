...
ESource *e_pilot_get_sync_source (ESourceRegistry *registry, const gchar *extension_name);
void e_pilot_set_sync_source (ESourceRegistry *registry, const gchar *extension_name, ESource *source);
