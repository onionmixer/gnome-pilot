...
#define E_PILOT_SETTINGS_GRID_ROWS 3
#define E_PILOT_SETTINGS_GRID_COLS 3
...
GtkWidget *e_pilot_settings_new      (ESourceRegistry *registry, const gchar *extension_name);
